...
static const float16_t convolve_float_default_f16_biases[] = {
    (float16_t)0.062561035f, (float16_t)-0.051025391f, (float16_t)0.204711914f, (float16_t)-1.818656921e-03f, (float16_t)-0.025878906f
};
...
static const float16_t convolve_float_default_f16_expected_output[] = {
    ...
    (float16_t)0.330322266f, (float16_t)-0.033782959f, (float16_t)0.8359375f, (float16_t)-0.00447464f, (float16_t)-0.75390625f, (float16_t)2.220153809e-03f, (float16_t)-1.17578125f, (float16_t)-1.150390625f, (float16_t)1.256835938f, (float16_t)-0.484619141f, (float16_t)-0.617675781f, (float16_t)0.641601562f, (float16_t)-0.281494141f, (float16_t)-0.113098145f, (float16_t)-0.258300781f, (float16_t)-0.960449219f,
    ...
    (float16_t)0.306152344f, (float16_t)-0.190795898f, (float16_t)1.65271759e-03f, (float16_t)0.100341797f, (float16_t)-0.481201172f, (float16_t)0.500976562f, (float16_t)-0.189086914f, (float16_t)-0.185791016f, (float16_t)-0.436279297f, (float16_t)-0.058685303f, (float16_t)0.671386719f, (float16_t)6.145477295e-03f, (float16_t)-0.207641602f, (float16_t)-0.404052734f, (float16_t)-0.736328125f, (float16_t)0.082702637f,
