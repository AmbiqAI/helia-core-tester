...
host compiler at -Ofast (the optimization level the generated tests build with,
which implies -ffinite-math-only) and drives every operand pairing.
"""
...
@pytest.mark.parametrize(
    ...
    [
        ("nan_vs_finite", "1.000000", "nan"),
        ("finite_vs_nan", "nan", "1.000000"),
        ("finite_vs_posinf", "+inf", "1.000000"),
        ("neginf_vs_posinf", "+inf", "-inf"),
        ("posinf_vs_finite", "1.000000", "+inf"),
