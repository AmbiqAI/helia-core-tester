...
def test_run_case_bundles_in_batches_splits_and_merges(tmp_path: Path, monkeypatch) -> None:
    ...
    def _fake_run_single_session(project_root, case_bundles, *, serial_no, chip_name, speed_khz, requested_counter_groups, build_dir, on_case_complete=None, expected_build_id=None):
