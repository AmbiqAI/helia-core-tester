"""Round-trip tests for the HCTP payload codec (helia_core_tester/hardware/wire.py).
...
from helia_core_tester.hardware.hctp import ByteReader
from helia_core_tester.hardware.measurement import CounterPass, RawCounterValue, RawSample, counter_passes_for_selection
from helia_core_tester.hardware.pmu_catalog import CPU_CYCLES_EVENT_ID, counter_by_name
from helia_core_tester.hardware import wire
...
def test_case_meta_rejects_rank_above_the_wire_limit() -> None:
    from helia_core_tester.hardware.hctp import ByteWriter
