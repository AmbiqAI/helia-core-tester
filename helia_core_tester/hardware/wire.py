...
(test_hardware_c_wire_compat.py, test_hardware_firmware_messages.py,
test_hardware_firmware_session.py) prove its bytes agree with this module.
...
# cmake/hardware/benchmark_server_catalog.h.
