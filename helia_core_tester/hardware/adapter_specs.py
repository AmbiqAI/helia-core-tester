"""Single source of truth for the hardware benchmark firmware's per-kernel dispatch C code.
...
places that could silently drift out of sync:
  ...
  1. `helia_core_tester/hardware/generated_test_bridge.py` -- a Python builder that
  ...
  2. A hand-typed `run_xxx_once()` C function in the firmware (historically inside
     `cmake/hardware/benchmark_server_session.c`) -- code that reads those same
...
generator script (`scripts/generate_hardware_adapters.py`) renders these bodies, plus
the `hct_run_kernel_once()` dispatch switch, into the fully generated
`cmake/hardware/benchmark_server_adapters.gen.c` (never edited by hand; `--check`
...
GENERATED_BLOCK_BEGIN = (
    ...
    "scripts/generate_hardware_adapters.py. DO NOT EDIT THIS FILE BY HAND: rerun the "
    "generator after editing adapter_specs.py. >>> */"
)
GENERATED_BLOCK_END = "/* <<< END GENERATED HARDWARE ADAPTERS <<< */"
...
class FirmwareAdapterSpec:
    ...
    be defined in `cmake/hardware/benchmark_server_adapters.h` and dispatched exactly
...
FIRMWARE_ADAPTERS: tuple[FirmwareAdapterSpec, ...] = (
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            ...
            "HCT_KERNEL_ID_DEPTHWISE_CONV_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
            "stride_h", "stride_w", "pad_h", "pad_w", "dilation_h", "dilation_w",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_AVGPOOL_S8",
            "HCT_KERNEL_ID_AVGPOOL_S16",
            "HCT_KERNEL_ID_MAXPOOL_S8",
            "HCT_KERNEL_ID_MAXPOOL_S16",
            "HCT_KERNEL_ID_AVGPOOL_F32",
            "HCT_KERNEL_ID_MAXPOOL_F32",
            "HCT_KERNEL_ID_AVGPOOL_F16",
            "HCT_KERNEL_ID_MAXPOOL_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_RELU_S8",
            "HCT_KERNEL_ID_RELU_S16",
            "HCT_KERNEL_ID_RELU6_S8",
            "HCT_KERNEL_ID_RELU6_S16",
            "HCT_KERNEL_ID_CLAMP_S8",
            "HCT_KERNEL_ID_CLAMP_S16",
            "HCT_KERNEL_ID_LEAKY_RELU_S8",
            "HCT_KERNEL_ID_LEAKY_RELU_S16",
            "HCT_KERNEL_ID_LOGISTIC_S16",
            "HCT_KERNEL_ID_TANH_S16",
            "HCT_KERNEL_ID_HARD_SWISH_COMPAT_S8",
            "HCT_KERNEL_ID_HARD_SWISH_PRECISE_S8",
            "HCT_KERNEL_ID_HARD_SWISH_PRECISE_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
            "output_h", "output_w", "output_c", "input_offset", "output_offset",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_PRELU_S8",
            "HCT_KERNEL_ID_PRELU_S16",
            "HCT_KERNEL_ID_PRELU_F32",
            "HCT_KERNEL_ID_PRELU_F16",
            "HCT_KERNEL_ID_PRELU_SCALAR_S8",
            "HCT_KERNEL_ID_PRELU_SCALAR_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
            "output_h", "output_w", "output_c", "input_offset", "output_offset",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_NN_ACTIVATION_FLOAT_F32",
            "HCT_KERNEL_ID_NN_ACTIVATION_FLOAT_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_QUANTIZE_S8",
            "HCT_KERNEL_ID_QUANTIZE_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_DEQUANTIZE_S8",
            "HCT_KERNEL_ID_DEQUANTIZE_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_REQUANTIZE_S8",
            "HCT_KERNEL_ID_REQUANTIZE_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_EQUAL_S8",
            "HCT_KERNEL_ID_EQUAL_S16",
            "HCT_KERNEL_ID_NOT_EQUAL_S8",
            "HCT_KERNEL_ID_NOT_EQUAL_S16",
            "HCT_KERNEL_ID_GREATER_S8",
            "HCT_KERNEL_ID_GREATER_S16",
            "HCT_KERNEL_ID_GREATER_EQUAL_S8",
            "HCT_KERNEL_ID_GREATER_EQUAL_S16",
            "HCT_KERNEL_ID_LESS_S8",
            "HCT_KERNEL_ID_LESS_S16",
            "HCT_KERNEL_ID_LESS_EQUAL_S8",
            "HCT_KERNEL_ID_LESS_EQUAL_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_TRANSPOSE_CONV_S8",
            "HCT_KERNEL_ID_TRANSPOSE_CONV_F32",
            "HCT_KERNEL_ID_TRANSPOSE_CONV_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_SOFTMAX_S8",
            "HCT_KERNEL_ID_SOFTMAX_S16",
            "HCT_KERNEL_ID_SOFTMAX_S8_S16",
            "HCT_KERNEL_ID_SOFTMAX_F32",
            "HCT_KERNEL_ID_SOFTMAX_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            ...
            "HCT_KERNEL_ID_FULLY_CONNECTED_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_BATCH_MATMUL_S8",
            "HCT_KERNEL_ID_BATCH_MATMUL_S16",
            "HCT_KERNEL_ID_BATCH_MATMUL_F32",
            "HCT_KERNEL_ID_BATCH_MATMUL_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_ARGMAX_S8",
            "HCT_KERNEL_ID_ARGMAX_S16",
            "HCT_KERNEL_ID_ARGMIN_S8",
            "HCT_KERNEL_ID_ARGMIN_S16",
            "HCT_KERNEL_ID_MEAN_S8",
            "HCT_KERNEL_ID_MEAN_S16",
            "HCT_KERNEL_ID_REDUCE_MAX_S8",
            "HCT_KERNEL_ID_REDUCE_MAX_S16",
            "HCT_KERNEL_ID_REDUCE_MIN_S8",
            "HCT_KERNEL_ID_REDUCE_MIN_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
            "output_n", "output_h", "output_w", "output_c",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_REDUCE_SUM_F32",
            "HCT_KERNEL_ID_REDUCE_SUM_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_RSQRT_S16_PER_OP",
            "HCT_KERNEL_ID_RSQRT_S16_UNIVERSAL",
            "HCT_KERNEL_ID_SQRT_S8",
            "HCT_KERNEL_ID_SQRT_S16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
            "input_offset", "output_offset", "out_mult", "out_shift",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_BATCH_NORM_F32",
            "HCT_KERNEL_ID_BATCH_NORM_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_ADD_S8",
            "HCT_KERNEL_ID_SUB_S8",
            "HCT_KERNEL_ID_MUL_S8",
            "HCT_KERNEL_ID_MAXIMUM_S8",
            "HCT_KERNEL_ID_MINIMUM_S8",
            "HCT_KERNEL_ID_SQUARED_DIFFERENCE_S8",
            "HCT_KERNEL_ID_ADD_S16",
            "HCT_KERNEL_ID_SUB_S16",
            "HCT_KERNEL_ID_MUL_S16",
            "HCT_KERNEL_ID_MAXIMUM_S16",
            "HCT_KERNEL_ID_MINIMUM_S16",
            "HCT_KERNEL_ID_SQUARED_DIFFERENCE_S16",
            "HCT_KERNEL_ID_ADD_F32",
            "HCT_KERNEL_ID_ADD_F16",
            "HCT_KERNEL_ID_SUB_F32",
            "HCT_KERNEL_ID_SUB_F16",
            "HCT_KERNEL_ID_MUL_F32",
            "HCT_KERNEL_ID_MUL_F16",
            "HCT_KERNEL_ID_MAXIMUM_F32",
            "HCT_KERNEL_ID_MAXIMUM_F16",
            "HCT_KERNEL_ID_MINIMUM_F32",
            "HCT_KERNEL_ID_MINIMUM_F16",
        ),
        guard="HCT_HOST_ABS_ONLY",
        scalar_fields=(
            "output_n", "output_h", "output_w", "output_c",
    ...
    FirmwareAdapterSpec(
        ...
        kernel_ids=(
            "HCT_KERNEL_ID_RESHAPE_S8",
            "HCT_KERNEL_ID_SQUEEZE_S8",
            "HCT_KERNEL_ID_TRANSPOSE_S8",
            "HCT_KERNEL_ID_TRANSPOSE_S16",
            "HCT_KERNEL_ID_PAD_S8",
            "HCT_KERNEL_ID_PAD_S16",
            "HCT_KERNEL_ID_MIRROR_PAD_S8",
            "HCT_KERNEL_ID_MIRROR_PAD_S16",
            "HCT_KERNEL_ID_CONCATENATION_S8",
            "HCT_KERNEL_ID_CONCATENATION_S16",
            "HCT_KERNEL_ID_CONCATENATION_S32",
            "HCT_KERNEL_ID_SPLIT_S8",
            "HCT_KERNEL_ID_SPLIT_S16",
            "HCT_KERNEL_ID_RESHAPE_F32",
            "HCT_KERNEL_ID_RESHAPE_F16",
            "HCT_KERNEL_ID_TRANSPOSE_F32",
            "HCT_KERNEL_ID_TRANSPOSE_F16",
            "HCT_KERNEL_ID_PAD_F32",
            "HCT_KERNEL_ID_PAD_F16",
            "HCT_KERNEL_ID_STRIDED_SLICE_F32",
            "HCT_KERNEL_ID_STRIDED_SLICE_F16",
            "HCT_KERNEL_ID_CONCATENATION_F32",
            "HCT_KERNEL_ID_CONCATENATION_F16",
            "HCT_KERNEL_ID_SPLIT_F16",
            "HCT_KERNEL_ID_BATCH_TO_SPACE_ND_S8",
            "HCT_KERNEL_ID_BATCH_TO_SPACE_ND_S16",
            "HCT_KERNEL_ID_SPACE_TO_BATCH_ND_S8",
            "HCT_KERNEL_ID_SPACE_TO_BATCH_ND_S16",
            "HCT_KERNEL_ID_SPACE_TO_DEPTH_S8",
            "HCT_KERNEL_ID_SPACE_TO_DEPTH_S16",
            "HCT_KERNEL_ID_DEPTH_TO_SPACE_S8",
            "HCT_KERNEL_ID_DEPTH_TO_SPACE_S16",
            "HCT_KERNEL_ID_RESIZE_NEAREST_NEIGHBOR_S8",
            "HCT_KERNEL_ID_RESIZE_NEAREST_NEIGHBOR_S16",
            "HCT_KERNEL_ID_TILE_S8",
            "HCT_KERNEL_ID_TILE_S16",
            "HCT_KERNEL_ID_GATHER_S8",
            "HCT_KERNEL_ID_GATHER_S16",
            "HCT_KERNEL_ID_GATHER_ND_S8",
            "HCT_KERNEL_ID_GATHER_ND_S16",
            "HCT_KERNEL_ID_WHERE_S8",
            "HCT_KERNEL_ID_WHERE_S16",
            "HCT_KERNEL_ID_SELECT_V2_S8",
            "HCT_KERNEL_ID_SELECT_V2_S16",
            "HCT_KERNEL_ID_REVERSE_SEQUENCE_S8",
            "HCT_KERNEL_ID_REVERSE_SEQUENCE_S16",
            "HCT_KERNEL_ID_SCATTER_ND_S8",
            "HCT_KERNEL_ID_SCATTER_ND_S16",
            "HCT_KERNEL_ID_BROADCAST_TO_S8",
            "HCT_KERNEL_ID_BROADCAST_TO_S16",
            "HCT_KERNEL_ID_DYNAMIC_UPDATE_SLICE_S8",
            "HCT_KERNEL_ID_DYNAMIC_UPDATE_SLICE_S16",
            "HCT_KERNEL_ID_STRIDED_SLICE_S8",
            "HCT_KERNEL_ID_STRIDED_SLICE_S16",
            "HCT_KERNEL_ID_STRIDED_SLICE_S32",
        ),
        guard="HCT_HOST_ABS_ONLY",
...
def render_generated_adapters_source(contracts: Optional[ContractSet] = None) -> str:
    ...
    pieces: list[str] = [
        ...
        "/* Forward declarations for helpers that adapters above their definition use. */",
        "static bool hct_checked_dims_bytes(const cmsis_nn_dims *dims,",
        "                                   uint32_t element_size,",
        "                                   uint32_t capacity,",
        "                                   uint32_t *output_bytes);",
