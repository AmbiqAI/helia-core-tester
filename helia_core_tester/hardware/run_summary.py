...
def build_json_summary(
    ...
    *,
    ...
    `dependencies` is the bundle's lock-derived provenance block, null when the
    run streamed to firmware with none recorded (--allow-unverified-firmware).
    It is the same object the bundle carries, so a caller consuming stdout never
    has to open the bundle to learn what was measured."""
