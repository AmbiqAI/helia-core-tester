...
static arm_cmsis_nn_status run_kernel_once(hct_server_session_t *session)
{
    switch (session->expected_kernel_id)
    {
        ...
        case HCT_KERNEL_ID_DEPTHWISE_CONV_F16:
#ifndef HCT_HOST_ABS_ONLY
        ...
        case HCT_KERNEL_ID_TRANSPOSE_CONV_F32:
        case HCT_KERNEL_ID_TRANSPOSE_CONV_F16:
#ifndef HCT_HOST_ABS_ONLY
        ...
        case HCT_KERNEL_ID_PRELU_SCALAR_S16:
            ...
            return ARM_CMSIS_NN_ARG_ERROR;
#endif
        case HCT_KERNEL_ID_NN_ACTIVATION_FLOAT_F32:
        case HCT_KERNEL_ID_NN_ACTIVATION_FLOAT_F16:
#ifndef HCT_HOST_ABS_ONLY
            return run_nn_activation_float_once(session);
#else
            return ARM_CMSIS_NN_ARG_ERROR;
#endif
        ...
        case HCT_KERNEL_ID_SOFTMAX_F16:
            ...
            return ARM_CMSIS_NN_ARG_ERROR;
#endif
        case HCT_KERNEL_ID_REDUCE_SUM_F32:
        case HCT_KERNEL_ID_REDUCE_SUM_F16:
#ifndef HCT_HOST_ABS_ONLY
            return run_reduce_sum_once(session);
#else
            return ARM_CMSIS_NN_ARG_ERROR;
#endif
        case HCT_KERNEL_ID_BATCH_NORM_F32:
        case HCT_KERNEL_ID_BATCH_NORM_F16:
#ifndef HCT_HOST_ABS_ONLY
            return run_batch_norm_once(session);
#else
            return ARM_CMSIS_NN_ARG_ERROR;
#endif
        ...
        case HCT_KERNEL_ID_FULLY_CONNECTED_F16:
#ifndef HCT_HOST_ABS_ONLY
        ...
        case HCT_KERNEL_ID_BATCH_MATMUL_F32:
        case HCT_KERNEL_ID_BATCH_MATMUL_F16:
#ifndef HCT_HOST_ABS_ONLY
